...
public class Application {
        ...
        while (true) {
            ...
            switch (choice) {
                ...
                case 6:
                    ...
                    break;
                case 7:
                    printActiveManagersList(managerService);
                    break;
                case 8:
                    printAllDepartments(departmentService);
                    break;
                default:
                    break;
            }
    ...
    public static void printActiveManagersList(ManagerService managerService) {
        List<Manager> allManager = managerService.loadAllActiveManagers();
        System.out.println("Aktif görev yapan yöneticiler");
    ...
    public static void printAllDepartments(DepartmentService departmentService) {
        List<Department> allDepart = departmentService.findAll();
